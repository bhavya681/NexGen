...
// const apiUrl = `https://newsapi.org/v2/everything?q=cricket&language=en&sortBy=publishedAt&apiKey=${apiKey}`;
...
//       <header className="bg-yellow-800 text-white p-4 mb-8 rounded-lg shadow-md">
//         <h1 className="text-3xl font-bold text-center">Cricket News</h1>
//       </header>
