...
const apiUrl = `https://newsapi.org/v2/everything?q=mma&language=en&sortBy=publishedAt&apiKey=${apiKey}`;
...
const MmaNews = () => {
  ...
  return (
    <div className="container mx-auto p-4 min-h-screen bg-gray-900 text-white">
      <header className="bg-red-800 text-white p-4 mb-8 rounded-lg shadow-md">
        <h1 className="text-3xl font-bold text-center">MMA News</h1>
      </header>
